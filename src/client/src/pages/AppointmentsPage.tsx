...
import MobileNavigation from '../components/appointments/MobileNavigation';
...
const AppointmentsPage = () => {
  ...
  const [viewMode, setViewMode] = useState<'day' | 'week' | 'month' | 'list'>(isMobile ? 'list' : 'week');
  ...
  // Ajustar vista por defecto según dispositivo
  useEffect(() => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Filters - Only show for non-mobile or when in list view */}
      ...
      {viewMode === 'day' ? (
        ...
        isMobile ? (
          <MobileAppointmentsList
            ...
            error={error}
            onAppointmentSelect={setSelectedAppointment}
            onQuickAction={handleStatusUpdate}
